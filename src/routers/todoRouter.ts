...
router.post('/', async (req, res) => {
    ...
    console.log(Description, date, picture, userId)
    ...
    const ID = await addTodo(Description, date, picture, userId);

    const newTask = {ID, Description, date, picture, userId, complete: false}
